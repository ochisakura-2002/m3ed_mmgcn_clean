...
- Project model implementations: **4** (`MMGCN`, project MultiDAG-inspired,
  `SDT`, `SimpleMLP`).
- Train/checkpoint/evaluate code paths: **3** (`MMGCN`, project
  MultiDAG-inspired, `SimpleMLP`).
- Synthetic-forward only: **1** (`SDT`).
...
| DialogueGCN | No project implementation | None | None | None | N/A | None | N/A | Unconfirmed | Unconfirmed | Unconfirmed | Unconfirmed | N/A | Not runnable | `unable_to_determine` |
